				...
				<form class="ns-form-horizontal" method="post" action="<?php echo esc_url($_SERVER['REQUEST_URI']); ?>"<?php
                    ...
                    <div class="ns-form-group">
						...
						<div class="ns-col-md-12 ns-col-sm-12 ns-col-xs-12">
							...
							<div id="ticket-retrun-adresse-div" style="overflow:auto;"> <?php
							
							echo '<table class="ns-ticket-retrun-adresse-table" style="border-bottom: 0; margin-bottom: 0;">';
							echo '<tbody><tr>
                    ...
                    <div class="ns-form-group">
                        <div class="ns-col-md-12 ns-col-sm-12 ns-col-xs-12">
							<div class="ns-form-submit">
								...
								<div id="ns_submit_disable" class="ns-btn ns-btn-primary ns-btn-ticket" style="display: none;">
									<?php if (qtranxf_getLanguage() == 'fr') { esc_html_e( 'Attendez...', 'nanosupport' ); } ?>
									<?php if (qtranxf_getLanguage() == 'en') { esc_html_e( 'Please wait...', 'nanosupport' ); } ?>
								</div>
