					...
					<div class="ticket-head-wrapper">
						<div class="ns-row ticket-meta">
							<div class="ns-col-sm-12 ns-col-xs-12">
								<div class="ticket-head-master">
									<h1 class="ticket-head ticket-head-title <?php echo esc_attr($highlight_class); ?>-title" style="border-color: <?php echo $get_term_color ?>; margin-bottom: 5px;">
										<span class="ticket-title-shadow" style="color: <?php echo $get_term_color ?>"><?php the_title(); ?></span>
									</h1>
								...
								<div class="ticket-head-master">
								<span class="ticket-title-shadow ticket-form-factor" style="color: <?php echo $get_term_color ?>; font-size: 25px;font-weight: 500; float: left;"><?php echo $lang_name_form_factor; ?></span>
									<div class="ticket-head-status">
